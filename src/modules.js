...
export default class Modules {
  ...
  handleOptionClick(event, elem) {
    const popup = document.createElement('div');
    popup.style.cssText = 'background:#fff;width:250px;height:50px;position:absolute;top:0;left:0;z-index:99999999999;box-shadow: rgba(0, 0, 0, 0.2) 4px 5px 24px 2px;';
    console.log(elem);
    elem.parentNode.insertBefore(popup, elem);
